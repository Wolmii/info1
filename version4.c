...
void progresser(int lesX[tailleT], int lesY[tailleT], char direction, bool* collision, bool*manger); //calculer l'avancée vers la droite
void dessinerSerpent(int lesX[tailleT], int lesY[tailleT]); //dessiner ler serpent depuis las coordonnées donnée (tête puis tout le corps)
